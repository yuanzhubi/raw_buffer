...
int main(){
	...
	//2: 你给一个可选数组字段赋值，赋值的长度为B, 然后接下来又给他重新赋值了一个长点的长度B+(即使B+比定义中的长度估计小)。
